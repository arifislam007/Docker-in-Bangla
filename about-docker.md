...
### 8. **মিনিমাল ওভারহেড:**
   ...
   Docker ব্যবহার করে একটি ওয়েব সার্ভিস তৈরি করার জন্য একটি ডকারফাইল তৈরি করার জন্য নিচের ডকারফাইল একটি উদাহরণ দেওয়া হলো যা একটি "হ্যালো ওয়ার্ল্ড" ওয়েব সার্ভিস তৈরি করে। এই ডকারফাইলটি একটি ওয়েব সার্ভার চালানোর জন্য একটি ইমেজ তৈরি করে যা একটি সাধারণ ওয়েব পেজ প্রদর্শন করে যা টেক্সট "হ্যালো ওয়ার্ল্ড" দেখাবে।

```Dockerfile
# ব্যবহার করা হবে ইমেজের বেস
FROM nginx:alpine

# ওয়েব সার্ভারের রুট ডিরেক্টরিতে ফাইল যুক্ত করা
COPY index.html /usr/share/nginx/html/

# ডকার কনটেইনার চালু হবে 80 পোর্টে
EXPOSE 80

# ওয়েব সার্ভার চালু করা
CMD ["nginx", "-g", "daemon off;"]
```

এই ডকারফাইলের উপর নির্ভর করে একটি `index.html` ফাইল তৈরি করুন যা ওয়েব পেজে "হ্যালো ওয়ার্ল্ড" টেক্সট দেখাবে। এই ফাইলটি ডকারফাইলের সাথে একই ডিরেক্টরিতে রাখুন।

```html
<!DOCTYPE html>
<html>
<head>
    <title>হ্যালো ওয়ার্ল্ড</title>
</head>
<body>
...
এই ডকারফাইল এবং `index.html` ফাইলটি ডকার ইমেজ তৈরি করার জন্য ব্যবহার করা হবে। এই ইমেজটি তৈরি করার পরে, আপনি এটি ডকার কনটেইনারে রান করতে পারেন এবং ওয়েব ব্রাউজারে ওয়েব সার্ভিসটি অ্যাক্সেস করতে পারেন।
